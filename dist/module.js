const $63f9c1adcd3d5964$export$df8169a6258d50c7 = {
...
const $63f9c1adcd3d5964$export$d827822e4858809f = [
    {
        desc: "\u043A\u0441 -> x",
...
const $63f9c1adcd3d5964$export$dde5208fce538b35 = {
...
const $63f9c1adcd3d5964$export$ebc19a8c8453432e = [
    {
...
const $f77fce4198feeb06$export$51b138e5a065c2bb = [
    {
        from: "be",
        to: "de",
        dict: {
        ...
        rules: [
            (0, $63f9c1adcd3d5964$export$df8169a6258d50c7),
            ...(0, $63f9c1adcd3d5964$export$d827822e4858809f),
            (0, $63f9c1adcd3d5964$export$dde5208fce538b35),
            ...(0, $63f9c1adcd3d5964$export$ebc19a8c8453432e),
            {
...
const $4c95a58a66a1f0ed$export$cf48009033a0126b = [
    {
        from: "ru",
        to: "de",
        dict: {
...
const $e1ea689111efe6e3$export$312745a8a3013c00 = [
    {
        from: "uk",
        to: "de",
        dict: {
...
const $e2e1ea6dd3b7d2e1$var$VOWELS = [
    "\u0430",
    "\u0435",
    "\u0454",
    "\u0451",
...
function $e2e1ea6dd3b7d2e1$export$8111e1eeaad1861d(char) {
    return $e2e1ea6dd3b7d2e1$var$VOWELS.includes(char);
}
function $e2e1ea6dd3b7d2e1$export$539e7ee389f27fc6(char = "", compareChar = "", word = "") {
    return $e2e1ea6dd3b7d2e1$var$isUpperCase(word) ? char.toUpperCase() : $e2e1ea6dd3b7d2e1$var$isUpperCase(compareChar) ? $e2e1ea6dd3b7d2e1$var$capitalizeFirst(char) : char;
}
function $e2e1ea6dd3b7d2e1$var$isUpperCase(str) {
    return str === str.toUpperCase();
}
function $e2e1ea6dd3b7d2e1$var$capitalizeFirst(str) {
...
class $9290cad888735bba$export$5af97e1f35ce3ad3 {
    ...
    transcribeWord(word = "") {
        ...
        return chars1.reduce((result, char, pos, chars)=>{
            ...
            return result + (0, $e2e1ea6dd3b7d2e1$export$539e7ee389f27fc6)(newChar, char, word);
        }, "");
    }
    getRuleBasedChar(char, pos, chars, word) {
        ...
        const args = {
            ...
            prev: charAtPos(-1),
            next: charAtPos(1),
            isVowel: $e2e1ea6dd3b7d2e1$export$8111e1eeaad1861d
        };
...
const $149c1bd638913645$var$DEFS = [
    ...(0, $f77fce4198feeb06$export$51b138e5a065c2bb),
    ...(0, $4c95a58a66a1f0ed$export$cf48009033a0126b),
    ...(0, $e1ea689111efe6e3$export$312745a8a3013c00)
];
const $149c1bd638913645$var$DEFAULT_OPTIONS = {
    from: "ru",
    to: "en",
    showDetails: false
};
function $149c1bd638913645$export$6479b296c537a758(input = "", _options = {}) {
    const options = {
        ...$149c1bd638913645$var$DEFAULT_OPTIONS,
        ..._options
    };
    const { from: from , to: to , showDetails: showDetails , debug: debug  } = options;
    const langDef = $149c1bd638913645$var$DEFS.find((d)=>d.from === from && d.to === to);
    if (!langDef) {
    ...
    const result = new (0, $9290cad888735bba$export$5af97e1f35ce3ad3)(langDef, !!debug).transcribe(input);
    return showDetails ? result : result.output;
}


export {$149c1bd638913645$export$6479b296c537a758 as transcribe};
